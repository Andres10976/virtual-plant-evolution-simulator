...
import { createPlant, growPlant, breedPlants, updateEnvironment } from '../../redux/plantsSlice';
...
const ControlPanel = () => {
  ...
  const handleBreedPlants = () => {
    if (selectedPlants.length === 2) {
      dispatch(breedPlants(selectedPlants[0], selectedPlants[1]));
      setSelectedPlants([]);
    }
  };
  ...
  return (
    <div className="control-panel">
      ...
      <button onClick={handleBreedPlants} disabled={selectedPlants.length !== 2}>
      ...
      <div>
        ...
        {plants.map(plant => (
          <button 
            ...
            style={{backgroundColor: selectedPlants.includes(plant._id) ? 'lightblue' : 'white'}}
          >
            Plant {plant._id}
          </button>
        ))}
      ...
      <div>
        ...
        <label>
          ...
          <input 
            ...
            onChange={(e) => handleEnvironmentChange('rainfall', e.target.value)}
          />
        ...
        <label>
          ...
          <input 
            ...
            onChange={(e) => handleEnvironmentChange('soilQuality', e.target.value)}
          />
        ...
        <label>
          ...
          <input 
            ...
            onChange={(e) => handleEnvironmentChange('sunlight', e.target.value)}
          />
